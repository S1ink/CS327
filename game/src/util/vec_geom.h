...
#define GENERATE_VEC2_UTILS(T, L) \
...
#define GENERATE_VEC3_UTILS(T, L) \
...
#define GENERATE_VEC2_ADD_SUB(T, L) \
...
#define GENERATE_VEC3_ADD_SUB(T, L) \
...
#define GENERATE_VEC2_CWISE_MIN_MAX(T, L) \
...
#define GENERATE_VEC3_CWISE_MIN_MAX(T, L) \
...
#define BUILD_FOR_TYPE(x, y) GENERATE_VEC2_UTILS(x, y)
BUILD_FOR_TYPES
#undef BUILD_FOR_TYPE

#define BUILD_FOR_TYPE(x, y) GENERATE_VEC3_UTILS(x, y)
BUILD_FOR_TYPES
#undef BUILD_FOR_TYPE

#define BUILD_FOR_TYPE(x, y) GENERATE_VEC2_ADD_SUB(x, y)
BUILD_FOR_TYPES
#undef BUILD_FOR_TYPE

#define BUILD_FOR_TYPE(x, y) GENERATE_VEC3_ADD_SUB(x, y)
BUILD_FOR_TYPES
#undef BUILD_FOR_TYPE

#define BUILD_FOR_TYPE(x, y) GENERATE_VEC2_CWISE_MIN_MAX(x, y)
BUILD_FOR_TYPES
#undef BUILD_FOR_TYPE

#define BUILD_FOR_TYPE(x, y) GENERATE_VEC3_CWISE_MIN_MAX(x, y)
BUILD_FOR_TYPES
#undef BUILD_FOR_TYPE
